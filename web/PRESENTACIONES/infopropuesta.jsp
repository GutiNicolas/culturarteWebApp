        ...
        <div id="home" class="home">
            <div class="container cont3" style="position:absolute; width:100%; height:100%">
                ...
                if (request.getAttribute("propuesta") != null) {
                    DtPropuestaWeb prop = (DtPropuestaWeb) request.getAttribute("propuesta");
                %>
                <br>
                    <img src="IMAGENES/defaultprop.jpg" class="imgprop" alt="" />
                    <h4 class="landing-text"><%=prop.getTitulo()%></h4>
                    <%
                    if((prop.getEstado().equals("Publicada") || prop.getEstado().equals("En financiacion")) && request.getAttribute("podes") != null){
                    %>
                    <div class="porqueria">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3 col-sm-4 col-xs-12" style="min-width: 50px">
                            <h6>Fecha: <%=prop.getFechaRealizacion()%></h6><br>
                            ...
                            <h6>Monto recaudado: <%=prop.getMontoactual()%></h6><br>                           
                        </div>
                    </div>
                </div>
                <%}%>
